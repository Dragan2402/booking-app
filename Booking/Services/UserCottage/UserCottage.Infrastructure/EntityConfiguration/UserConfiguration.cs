...
public class UserConfiguration : AEntityTypeConfiguration<User>
{
    ...
    private List<User> CreateSeed()
    {
        ...
        usersList.Add(new User(new Guid("8e10d5fc-600d-49ff-8d1c-ca15872af496"))
        {
        ...
        usersList.Add(new User(new Guid("59249fab-eec0-435c-9df9-5aba2c082f39"))
        {
        ...
        usersList.Add(new User(new Guid("fdb5d61d-f6b9-4b0f-8869-4a9bebeb128a"))
        {
        ...
        usersList.Add(new User(new Guid("a1829896-9b2a-4e4f-b732-0b2414547802"))
        {
